...
class __TwigTemplate_01a3832996a85138e2b1cd3615b625c9beb7926be5ff009028d5979dd4e3d59b extends Twig_Template
{
...
<html lang=\"es\">
    ...
    <body>
        ...
        if ($this->getAttribute($this->getAttribute(($context["app"] ?? null), "user", array(), "any", false, true), "id", array(), "any", true, true)) {
            // line 58
            echo "                            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("usuario_show", array("id" => $this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "id", array()))), "html", null, true);
            ...
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "apellidos", array()), "html", null, true);
            echo "</a>
                                ";
        }
        // line 60
        ...
        <div id=\"wrapper\">
            ...
            <nav class=\"navbar navbar-default navbar-static-top\" role=\"navigation\" style=\"margin-bottom: 0\">
                <div class=\"navbar-header\">
                    ...
                    <a class=\"navbar-brand\" href=\"{{path(\"home\")}}\">FACELET</a>
                </div>
                <!-- /.navbar-header -->
...
", "FactelBundle::Layout.html.twig", "C:\\xampp\\htdocs\\FactelCliente\\src\\FactelBundle/Resources/views/Layout.html.twig");
    }
}
