...
class __TwigTemplate_b199f911e4d245d999b0ff13724d27699909eb29d53b45be9c76ffaa7358efd4 extends Twig_Template
{
                ...
                <div class=\"panel-heading\">
                    <div class=\"row\">
                        ...
                        <div class=\"col-xs-9 text-right\">
                            <div class=\"huge\">";
            // line 22
            echo twig_escape_filter($this->env, ($context["registrados"] ?? $this->getContext($context, "registrados")), "html", null, true);
            echo "</div>
                            <div>Registrados</div>
                        </div>
                    </div>
                ...
                <div class=\"panel-heading\">
                    <div class=\"row\">
                        ...
                        <div class=\"col-xs-9 text-right\">
                            <div class=\"huge\">";
            // line 39
            echo twig_escape_filter($this->env, ($context["autorizados"] ?? $this->getContext($context, "autorizados")), "html", null, true);
            echo "</div>
                            <div>Autorizados</div>
                        </div>
                    </div>
                ...
                <div class=\"panel-heading\">
                    <div class=\"row\">
                        ...
                        <div class=\"col-xs-9 text-right\">
                            <div class=\"huge\">";
            // line 57
            echo twig_escape_filter($this->env, ($context["procesandose"] ?? $this->getContext($context, "procesandose")), "html", null, true);
            echo "</div>
                ...
                <div class=\"panel-heading\">
                    <div class=\"row\">
                        ...
                        <div class=\"col-xs-9 text-right\">
                            <div class=\"huge\">";
            // line 74
            echo twig_escape_filter($this->env, ($context["noAutorizados"] ?? $this->getContext($context, "noAutorizados")), "html", null, true);
            echo "</div>
    ...
    new Chart(document.getElementById(\"line-chart\"), {
        ...
        data: {
            ...
            datasets: [{
                    data: [";
            // line 108
            echo twig_escape_filter($this->env, ($context["ventaTotalActual"] ?? $this->getContext($context, "ventaTotalActual")), "html", null, true);
            echo "],
                    label: \"2018\",
                    borderColor: \"#3e95cd\",
                    fill: false
                    ...
                    data: [";
            // line 113
            echo twig_escape_filter($this->env, ($context["ventaTotalAnnoAnterior"] ?? $this->getContext($context, "ventaTotalAnnoAnterior")), "html", null, true);
            echo "],
                    label: \"2017\",
                    borderColor: \"#3cba9f\",
                    fill: false
            ...
            datasets: [
                {
                    ...
                    data: [";
            // line 136
            echo twig_escape_filter($this->env, ($context["ventaXDiaTotal"] ?? $this->getContext($context, "ventaXDiaTotal")), "html", null, true);
            echo "]
                }
            ]
        },
...
{% endif %}
{% endblock %}
", "FactelBundle:Inicio:inicio.html.twig", "C:\\xampp\\htdocs\\FactelCliente\\src\\FactelBundle/Resources/views/Inicio/inicio.html.twig");
    }
}
