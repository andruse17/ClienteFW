...
class __TwigTemplate_d3533f0f24fae8bcf2d55aa21738234137e83ca35b9abeb0766bbb8340038ace extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(array("logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", array())));
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(array("exception" => ($context["exception"] ?? $this->getContext($context, "exception"))));
        // line 92
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "C:\\xampp\\htdocs\\FactelCliente\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
