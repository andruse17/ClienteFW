...
class __TwigTemplate_034af910b27f5c03d4063bf1da9e8efdacb2986fb2ebce23436b233c54b7517c extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_5888fd36c2b7eb291fee247654e4a71dfbc09abf7f364419cf02865890bd65a2"] = $this;
        // line 1
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms", array()))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 188
                echo "                    ";
                echo $context["__internal_5888fd36c2b7eb291fee247654e4a71dfbc09abf7f364419cf02865890bd65a2"]->getform_tree_entry($context["formName"], $context["formData"], true);
                echo "
                ";
            }
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 194
                echo "                ";
                echo $context["__internal_5888fd36c2b7eb291fee247654e4a71dfbc09abf7f364419cf02865890bd65a2"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
$context["trace"], "message", array(), "any", true, true)) {
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["childName"] => $context["childData"]) {
                // line 676
                echo "        ";
                echo $this->getAttribute($this, "form_tree_details", array(0 => $context["childName"], 1 => $context["childData"], 2 => ($context["forms_by_hash"] ?? $this->getContext($context, "forms_by_hash"))), "method");
                echo "
    ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "C:\\xampp\\htdocs\\FactelCliente\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\form.html.twig");
    }
}
