...
class __TwigTemplate_ef0fab2372972cfc5b4ae2d1bd34c309680e21a77fc4e3caafade8ac318ddf1a extends Twig_Template
{
        ...
        if ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "notcalledlisteners", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 51
                echo $context["__internal_b5d9e1950ac6aca6aeafadb6c13f104aab2ca25614677593b5af8679b9160c2c"]->getdisplay_listener($this->getAttribute(($context["listeners"] ?? $this->getContext($context, "listeners")), $context["listener"], array(), "array"));
                echo "</code></td>
                </tr>
            ";
            }
...
{% macro display_listener(listener) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "C:\\xampp\\htdocs\\FactelCliente\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\events.html.twig");
    }
}
